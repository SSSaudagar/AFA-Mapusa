<?php
    ...
    $sql="SELECT `date`, `place`, programmes.name, `areas`.`name` as area FROM `programmes` join areas on programmes.area=areas.id WHERE 1 order by date desc ";
    $pgms=mysql_query($sql);
    $sql="SELECT `date`, `presentation` FROM `meetings` WHERE 1 order by date desc ";
